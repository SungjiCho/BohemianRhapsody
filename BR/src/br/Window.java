...
public class Window extends JFrame{	
	...
	public void Game(int nowSelected) {	
		...
		trackList.add(new Track("BohemianRhapsody.png", "BohemianRhapsody Start.png", "BohemianRhapsody Game.jpg", 
				"Bohemian Rhapsody Selected.mp3", "Queen - Bohemian Rhapsody.mp3", "Queen - Bohemian Rhapsody"));
		trackList.add(new Track("WeAreTheChampion.png", "WeAreTheChampion Start.png", "WeAreTheChampion Game.png", 
				"We Are The Champion Selected.mp3", "Queen - We Are The Champion.mp3", "Queen - We Are The Champion"));
		...
		playButton.setBounds(200, 320, 280, 280);
		...
		startButton.setBounds(490, 500, 300, 150);
		...
		backButton.setBounds(20, 50, 70, 35);
